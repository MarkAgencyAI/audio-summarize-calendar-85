  ...
  return <Layout>
      <div className="space-y-10">
        <div className="space-y-6">
          <h1 className="text-3xl font-bold text-slate-50">{pageTitle}</h1>
          
          {/* Show AudioRecorder to students, PdfUploader to teachers */}
          {!isTeacher ? <AudioRecorder /> : <div className="glassmorphism rounded-xl p-4 md:p-6 shadow-lg mb-8 dark:bg-custom-secondary/20 dark:border-custom-secondary/40">
              <PdfUploader />
            </div>}
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-slate-50">{`Tus ${pageTitle}`}</h2>
